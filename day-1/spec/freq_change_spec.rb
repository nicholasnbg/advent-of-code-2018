...
RSpec.describe FrequencyChanger do
  ...
  describe '#first_repeat' do
    subject { frequency_changer.first_repeat(frequencies1) }
    it 'returns -1' do
      expect(subject).to eq -1
    end
  end
